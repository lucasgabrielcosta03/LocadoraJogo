...
include 'BancolocadoraJogos.php';
  ...
  echo "Banco de dados selecionado.<br>";
	...
	$result=mysqli_query($link,"SELECT * FROM tblusuarios WHERE usrusuario='".$_REQUEST["txtUsuario"]."'");
	...
	if ($row){
        ...
        $strSql = "INSERT INTO tblusuarios (usrid,usrnome,usrusuario,usrsenha) values (NULL,";
        $strSql .= "'" . $_POST["txtNome"]. "',";
        $strSql .= "'" . $_POST["txtUsuario"]. "',";
        $strSql .= "'" . $_POST["txtSenha"]. "')";
